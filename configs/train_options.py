...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        parser.add_argument('--resume_geometry_from',  type=str, default='C:\\Users\\lahir\\code\\defocusVdepth\\checkpoints\\v1-5-pruned-emaonly.ckpt', help='the checkpoint file to resume from')
        parser.add_argument('--resume_blur_from',  type=str, default='C:\\Users\\lahir\\Documents\\bweigth0.05_model_539.tar', help='the checkpoint file to resume from')
