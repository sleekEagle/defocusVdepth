...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        parser.add_argument('--resume_blur_from',  type=str, default='C:\\Users\\lahir\\Documents\\refocused_f_25_fdist_2.tar', help='the checkpoint file to resume from')
        parser.add_argument('--resume_selector_from',  type=str, default='C:\\Users\\lahir\\models\\VPD\\selector_refocused_f_25_fdist_2.tar', help='the checkpoint file to resume from')
