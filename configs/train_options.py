...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        parser.add_argument('--resume_geometry_from',  type=str, default='/p/blurdepth/models/vpd_depth_480x480.pth', help='the checkpoint file to resume from')
        parser.add_argument('--resume_blur_from',  type=str, default='/p/blurdepth/models/defnet/refocused_f_25_fdist_2.tar', help='the checkpoint file to resume from')
